      ...
      {/if}
          ...
          <div class="row">
            {block name="left_column"}
              <div id="left-column" class="sidebar col-xs-12 col-sm-12 col-md-4 col-lg-3{if isset($profile_params.c_config.use_button_toggle) && $profile_params.c_config.use_button_toggle}{if $profile_params.c_config.filter_position == 2} hidden-md-up{else} filter-toggle{/if}{else}{if isset($profile_params.c_config.filter_position) && $profile_params.c_config.filter_position == 2} hidden-md-up{/if}{/if}">
