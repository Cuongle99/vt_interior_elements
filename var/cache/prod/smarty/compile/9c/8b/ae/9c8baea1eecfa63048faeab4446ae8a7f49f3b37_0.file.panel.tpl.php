...
/* Smarty version 4.3.4, created on 2024-09-13 07:22:32
  from 'D:\xampp\htdocs\prestashop\vt_interior_elements\modules\leoelements\views\templates\admin\leo_elements_hook\panel.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66e42078a8da35_18713239',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9c8baea1eecfa63048faeab4446ae8a7f49f3b37' => 
    array (
      0 => 'D:\\xampp\\htdocs\\prestashop\\vt_interior_elements\\modules\\leoelements\\views\\templates\\admin\\leo_elements_hook\\panel.tpl',
      1 => 1676345970,
      2 => 'file',
    ),
  ),
...
function content_66e42078a8da35_18713239 (Smarty_Internal_Template $_smarty_tpl) {
if ($_smarty_tpl->tpl_vars['showed']->value == true) {?>
 <div id="leo-page" class="clearfix">
	
	<div class="note">

		<p>+ <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Drop modules from hooks layouts to "<b>UnHook Modules</b>" Panel to unhook them','mod'=>'leoelements'),$_smarty_tpl ) );?>
. <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Drag and drop modules from hooks layouts to update theirs order and hook position','mod'=>'leoelements'),$_smarty_tpl ) );?>
</p>
		<p>+  <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Override hook feature only applies for <b>HOOK_HEADERRIGHT, HOOK_SLIDESHOW, HOOK_TOPNAVIATION, HOOK_SLIDESHOW, HOOK_PROMOTETOP, HOOK_CONTENTBOTTOM, HOOK_BOTTOM</b>','mod'=>'leoelements'),$_smarty_tpl ) );?>
</p>
		<p>+ <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Here only shows all of installed modules having hooks supportting for LeoTheme Layout.','mod'=>'leoelements'),$_smarty_tpl ) );?>

	</div>	
	<div class="leo-container holdposition" id="noposition">
		<div class="pos"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'UnHook Modules','mod'=>'leoelements'),$_smarty_tpl ) );?>
 </div>
		 <?php
...
&action=overridehook" method="post">
	<p class="clearfix"><label><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Select override hook','mod'=>'leoelements'),$_smarty_tpl ) );?>
</lable><br>
	<select  name="name_hook">
		<option value="0"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'--- Use Self Hook ---','mod'=>'leoelements'),$_smarty_tpl ) );?>
</option>
	...
	<input type="submit" value="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Save','mod'=>'leoelements'),$_smarty_tpl ) );?>
" name="submit" />
	</p>
	</form>
</div>	
